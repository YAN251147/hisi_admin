//定义一个依赖于其他模块的自定义模块，通过exports定义方法‘global’
layui.define(['element', 'form'], function(exports) {
    ...
    if (window.localStorage.getItem("adminNavTag")) {//.addClass('layui-this')
        $('#switchNav a[href="'+window.localStorage.getItem("adminNavTag")+'"]').parent('dd').parents('li').addClass('layui-nav-itemed').siblings('li').removeClass('layui-nav-itemed');
    }
